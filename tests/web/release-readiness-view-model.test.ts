...
test("release readiness view model exposes release list, checks, blockers and evidence", () => {
  ...
  assert.equal(viewModel.releases[0].status.label, "阻塞");
